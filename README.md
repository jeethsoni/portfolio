...
[![Vercel Deploy](https://img.shields.io/badge/Deployed%20on-Vercel-black?logo=vercel&logoColor=white)](https://justdev.com)
...
Built with **Next.js**, **React**, and **TailwindCSS**, this site reflects my journey as a **software engineer, product builder, and creative technologist**.
...
![Portfoliio](/public/projects/portfolio.png)
...
```bash
git clone https://github.com/jeethsoni/portfolio.git
cd portfolio
npm install
npm run dev
