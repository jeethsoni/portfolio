...
export function Globe({
  ...
  useEffect(() => {
    ...
    globeMaterial.color = new Color(globeConfig.globeColor || "#1e3a8a");
    globeMaterial.emissive = new Color(globeConfig.emissive || "#0a1a33");
    globeMaterial.emissiveIntensity = 0.05; // dim glow
